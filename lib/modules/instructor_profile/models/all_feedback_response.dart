class AllFeedbackResponse {
  String? status;
  Data? data;

  AllFeedbackResponse({this.status, this.data});

  AllFeedbackResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Satisfactions {
  ...
  Satisfactions({this.students, this.satisfaction});
